...
class BuffMap : public Dictionary<string, RoomBuff *>
{
  public:
    static std::shared_ptr<const Dictionary<string, RoomBuff *>> instance()
    {
        static std::shared_ptr<const Dictionary<string, RoomBuff *>> instance{new BuffMap()};
        return instance;
    }
...
static void post_process_buff_map(
    Dictionary<string, RoomBuff *> &buffs) // this function will be called after all buff models are loaded
{
...
static void init_buffs(Dictionary<string, RoomBuff *> &buffs)
{
    ...
    buffs["manu_prod_spd_addition[030]"] =
        new IncEffOverTime(0.2, 0.01, 0.05, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_HOTHEAD);
    buffs["manu_prod_spd_addition[031]"] =
        new IncEffOverTime(0.2, 0.01, 0.05, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_HOTHEAD);
    buffs["manu_prod_spd_addition[040]"] =
        new IncEffOverTime(0.15, 0.02, 0.10, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_SLOWCOACH);
    buffs["manu_prod_spd_addition[041]"] =
        new IncEffOverTime(0.15, 0.02, 0.10, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_SLOWCOACH);

    buffs["manu_prod_spd&limit[000]"] =
        new BasicInc(0.1, 6, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_AND_CAP);
    buffs["manu_prod_spd&limit[001]"] =
        new BasicInc(0.1, 10, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_AND_CAP);

    buffs["manu_prod_limit&cost[000]"] =
        new BasicInc(0, 8, -0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_JUNKMAN);
    ...
    buffs["manu_prod_limit&cost[010]"] = new BasicInc(0, 10, -0.25, CharCostModifierType::SELF,
                                                      bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_JUNKMAN);
    buffs["manu_prod_limit&cost[020]"] = new BasicInc(0, 16, -0.25, CharCostModifierType::SELF,
                                                      bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_JUNKMAN);

    buffs["manu_formula_cost[000]"] =
        new BasicInc(0, 0, -0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_VLOG);
    ...
    buffs["manu_prod_spd&limit&cost[000]"] =
        new BasicInc(-0.05, 16, -0.15, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE,
                     RoomBuffType::FACTORY_CRAFTSMANSHIP_SPIRIT);
    buffs["manu_prod_spd&limit&cost[001]"] =
        new BasicInc(-0.05, 19, -0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE,
                     RoomBuffType::FACTORY_CRAFTSMANSHIP_SPIRIT);
    buffs["manu_prod_spd&limit&cost[010]"] = new BasicInc(
        0.25, -12, 0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_TROUBLE_MAKER);
    buffs["manu_prod_spd&limit&cost[011]"] = new BasicInc(
        0.25, -12, 0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_TROUBLE_MAKER);
    buffs["manu_prod_spd&limit&cost[020]"] = new BasicInc(
        -0.2, 17, -0.25, CharCostModifierType::SELF, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_TROUBLE_MAKER);
    buffs["manu_prod_spd_variable[000]"] = new IncEffByOtherCapInc(0, 0.02, 0.02); // TODO:优先级
    buffs["manu_prod_spd_variable2[000]"] = new IncEffByOtherEffInc(0.05, 0.05, 0.4, bm::RoomType::MANUFACTURE,
    ...
    buffs["manu_prod_spd_bd[000]"] =
        new IncEffByGlobalAttribute(1, 0.005, GlobalAttributeType::CHAIN_OF_THOUGHT, bm::RoomType::MANUFACTURE,
                                    RoomBuffType::FACTORY_INC_EFF_BY_CHAIN_OF_THOUGHT);
    buffs["manu_prod_spd_bd[010]"] =
        new IncEffByGlobalAttribute(1, 0.01, GlobalAttributeType::CHAIN_OF_THOUGHT, bm::RoomType::MANUFACTURE,
                                    RoomBuffType::FACTORY_INC_EFF_BY_CHAIN_OF_THOUGHT);

    buffs["manu_formula_spd[000]"] =
        new BasicInc(0.3, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_RECORD);
    ...
    buffs["manu_formula_spd[020]"] =
        new BasicInc(0.35, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_RECORD);
    buffs["manu_formula_spd[020]"]->AddValidator(new ProdTypeSelector(ProdType::RECORD));

    buffs["manu_prod_spd&trade[000]"] =
        new IncEffByGlobalAttribute(1, 0.2, GlobalAttributeType::TRADING_POST_CNT, bm::RoomType::MANUFACTURE,
    ...
    buffs["manu_formula_spd[100]"] =
        new BasicInc(0.3, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_GOLD);
    buffs["manu_formula_spd[100]"]->AddValidator(new ProdTypeSelector(ProdType::GOLD));

    buffs["manu_formula_spd[101]"] =
        new BasicInc(0.35, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_GOLD);
    buffs["manu_formula_spd[101]"]->AddValidator(new ProdTypeSelector(ProdType::GOLD));

    buffs["manu_formula_spd[200]"] =
        new BasicInc(0.30, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_ORIGINIUM);
    ...
    buffs["manu_formula_spd[210]"] =
        new BasicInc(0.35, 0, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_ORIGINIUM);
    ...
    buffs["manu_cost_all[000]"] = new BasicInc(0, 0, 0, CharCostModifierType::ROOM_CLEAR_ALL, bm::RoomType::MANUFACTURE,
    ...
    buffs["manu_skill_spd1[010]"] = new IncEffByStandardizationCnt(
        0.05, bm::RoomType::MANUFACTURE, RoomBuffType::FACTORY_INC_EFF_BY_STANDARDIZATION_CNT);
    ...
    buffs["trade_ord_spd_variable2[000]"] =
        new IncEffByOtherEffInc(0.05, 0.05, 0.25, bm::RoomType::TRADING, RoomBuffType::TRADING_HEAVENLY_REWARD);
    buffs["trade_ord_spd_variable2[001]"] =
        new IncEffByOtherEffInc(0.05, 0.05, 0.35, bm::RoomType::TRADING, RoomBuffType::TRADING_HEAVENLY_REWARD);
    buffs["trade_ord_spd&limit[010]"] =
        new BasicInc(0.25, 1, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    buffs["trade_ord_spd&limit[020]"] =
        new BasicInc(0.15, 2, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    buffs["trade_ord_spd&limit[021]"] =
        new BasicInc(0.15, 4, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    buffs["trade_ord_spd&limit[022]"] =
        new BasicInc(0.20, 4, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    buffs["trade_ord_spd&limit[030]"] =
        new BasicInc(0.20, 0, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    buffs["trade_ord_spd&limit[031]"] =
        new BasicInc(0.30, 1, bm::RoomType::TRADING, RoomBuffType::TRADING_INC_EFF_AND_CAP);
    ...
    buffs["trade_ord_limit&cost[000]"] =
        new BasicInc(0, 5, -0.25, CharCostModifierType::SELF, bm::RoomType::TRADING, RoomBuffType::TRADING_NEGOTIATION);
    ...
    buffs["trade_ord_spd&limit[000]"] = new BasicInc(0.1, 2, 0, CharCostModifierType::SELF, bm::RoomType::TRADING,
                                                     RoomBuffType::TRADING_INC_EFF_AND_CAP);

    // "trade_ord_spd&limit[001]": 订单管理·β: 进驻贸易站时，订单获取效率+10%，且订单上限+4
    buffs["trade_ord_spd&limit[001]"] = new BasicInc(0.1, 4, 0, CharCostModifierType::SELF, bm::RoomType::TRADING,
                                                     RoomBuffType::TRADING_INC_EFF_AND_CAP);
    ...
    post_process_buff_map(buffs);
}
} // namespace albc::buff_map

using namespace albc::buff_map;